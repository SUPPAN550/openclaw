...
ANALYST_ORDER = ["market", "social", "news", "fundamentals", "macro", "smart_money", "sentiment", "industry", "valuation", "financial_quality", "management", "risk", "institutional", "flows", "game_theory"]
ANALYST_AGENT_NAMES = {
...
class AnalyzeRequest(UserContextInput):
    ...
    selected_analysts: List[str] = Field(
        default_factory=lambda: ["market", "social", "news", "fundamentals", "macro", "smart_money", "sentiment", "industry", "valuation", "financial_quality", "management", "risk", "institutional", "flows", "game_theory"]
    )
...
class BacktestRequest(BaseModel):
    ...
    start_date: str
    end_date: str
    selected_analysts: List[str] = ["market", "social", "news", "fundamentals", "macro", "smart_money", "sentiment", "industry", "valuation", "financial_quality", "management", "risk", "institutional", "flows", "game_theory"]
    hold_days: int = 5
