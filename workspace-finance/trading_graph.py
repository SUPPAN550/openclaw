...
class TradingAgentsGraph:
    ...
    def __init__(
        self,
        selected_analysts=["market", "social", "news", "fundamentals", "macro", "smart_money", "sentiment", "industry", "valuation", "financial_quality", "management", "risk", "institutional", "flows", "game_theory"],
        debug=False,
