...
ANALYST_AGENT_NAMES = {
    ...
    "financial_quality": "Financial Quality Analyst",
    "management": "Management Analyst",
    "risk": "Risk Analyst",
    "institutional": "Institutional Analyst",
    "flows": "Flows Analyst",
...
ANALYST_REPORT_MAP = {
    ...
    "financial_quality": "financial_quality_report",
...
class AnalyzeRequest(UserContextInput):
    ...
    selected_analysts: List[str] = Field(
        default_factory=lambda: ["market", "social", "sentiment", "news", "fundamentals", "macro", "smart_money", "industry", "valuation", "financial_quality", "management", "risk", "institutional", "flows", "game_theory"]
    )
