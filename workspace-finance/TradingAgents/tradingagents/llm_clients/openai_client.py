...
class OpenAIClient(BaseLLMClient):
    ...
    def get_llm(self) -> Any:
        ...
        if self.provider == "xai":
            ...
            # Use the API key from environment or pass through
            llm_kwargs["base_url"] = self.base_url or "https://api.minimaxi.com/v1"
            # MiniMax requires specific header handling
            # Try to get from environment or kwargs
