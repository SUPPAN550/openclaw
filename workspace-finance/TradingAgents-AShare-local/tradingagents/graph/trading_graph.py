...
class TradingAgentsGraph:
    ...
    def __init__(
        self,
        selected_analysts=["market", "social", "sentiment", "news", "fundamentals", "macro", "smart_money", "industry", "valuation", "financial_quality", "management", "risk", "institutional", "flows", "game_theory"],
        debug=False,
    ...
    def _create_tool_nodes(self) -> Dict[str, ToolNode]:
        ...
        return {
            ...
            # New analyst tool nodes for 15-analyst version
            "sentiment": ToolNode(
                [
            ...
            "financial_quality": ToolNode(
                [
                    # Financial quality analysis tools
                    get_balance_sheet,
                    get_income_statement,
                    get_cashflow,
                ]
    ...
    def _build_horizon_result(self, horizon: str, final_state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "financial_quality_report": final_state.get("financial_quality_report", ""),
            "management_report": final_state.get("management_report", ""),
            "risk_report": final_state.get("risk_report", ""),
            "institutional_report": final_state.get("institutional_report", ""),
            "flows_report": final_state.get("flows_report", ""),
        }
