...
def _default_should_continue(state: AgentState):
    """Default should_continue implementation for any analyst."""
...
class ConditionalLogic:
    ...
    def __getattr__(self, name):
        """Fallback for missing should_continue_* methods."""
        if name.startswith("should_continue_"):
            return _default_should_continue
